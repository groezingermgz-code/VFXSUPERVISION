...
const translations = {
  de: {
    ...
    takes: {
      title: "Takes",
      add: "Take hinzufügen",
      addTitle: "Take hinzufügen",
      hintLabel: "Hinweis",
      emptyEdit: "Noch keine Takes hinzugefügt.",
    ...
    camera: {
      ...
      selectColorSpace: "Color Space auswählen...",
    ...
    lens: {
      ...
      focalLengthManual: "Brennweite (manuell)",
      focalLengthPlaceholderShort: "z. B. 35",
      zoomRangeHint: "Zoom-Objektiv: Nur Werte innerhalb des Bereichs zulässig.",
      aperture: "Blende",
      focus: "Fokus",
    ...
    tools: {
      ...
      fov: {
        ...
        controls: {
          ...
          manualFocalLength: "Brennweite (manuell)",
  ...
  en: {
    ...
    takes: {
      ...
      addTitle: "Add take",
      hintLabel: "Hint",
      emptyEdit: "No takes added yet.",
      emptyRead: "No takes available.",
      cameraLabelPrefix: "Camera",
      clipIdLabel: "Clip ID",
      noteLabel: "Note",
      notePlaceholder: "Short note about the take",
      changesLabel: "Changes",
      changesPlaceholder: "Changed points, deviations, notes …",
      quickRatingAria: "Quick rating",
      ratingTitlePrefix: "Rating",
      removeTitle: "Remove take"
    },
    feedback: {
      title: "Feedback",
      description:
    ...
    lens: {
      ...
      focalLengthManual: "Focal Length (manual)",
      focalLengthPlaceholderShort: "e.g., 35",
      zoomRangeHint: "Zoom lens: only values within range allowed.",
      aperture: "Aperture",
      focus: "Focus",
    ...
    tools: {
      ...
      fov: {
        ...
        controls: {
          ...
          manualFocalLength: "Focal Length (manual)",
  ...
  fr: {
    ...
    takes: {
      ...
      addTitle: "Ajouter une prise",
      hintLabel: "Remarque",
      emptyEdit: "Aucune prise ajoutée pour l’instant.",
      emptyRead: "Aucune prise disponible.",
      cameraLabelPrefix: "Caméra",
      clipIdLabel: "ID de clip",
      noteLabel: "Note",
      notePlaceholder: "Brève note sur la prise",
      changesLabel: "Modifications",
      changesPlaceholder: "Points modifiés, écarts, remarques …",
      quickRatingAria: "Évaluation rapide",
      ratingTitlePrefix: "Évaluation",
      removeTitle: "Supprimer la prise"
    },
    settings: {
      title: "Paramètres",
    ...
    clip: {
      namingLabel: "Nom du clip",
      cameraIndexLabel: "Index caméra",
      cameraIndexPlaceholder: "A",
      reelNumberLabel: "Numéro de bobine",
      reelNumberPlaceholder: "001",
      clipNumberLabel: "Numéro de clip",
      clipNumberPlaceholder: "001",
      manualIdLabel: "ID de clip manuelle",
      manualIdPlaceholder: "Personnalisé",
      namingFormatHint: "Format : [Index caméra][Numéro de bobine]_C[Numéro de clip], p. ex. A001_C001",
      manualOverridesHint: "L’ID de clip manuelle remplace le format ci-dessus."
    },
    shot: {
    ...
    lens: {
      ...
      lens: "Objectif",
      focalLength: "Focale",
      focalLengthManual: "Focale (manuel)",
      focalLengthPlaceholderShort: "p. ex., 35",
      zoomRangeHint: "Objectif zoom : seules les valeurs dans la plage sont autorisées.",
      aperture: "Ouverture",
      focus: "Mise au point",
    ...
    tools: {
      ...
      fov: {
        ...
        controls: {
          ...
          manualFocalLength: "Focale (manuelle)",
          projection: "Projection",
          projectionOptions: {
  ...
  es: {
    ...
    takes: {
      title: "Tomas",
      add: "Añadir toma",
      addTitle: "Añadir toma",
      hintLabel: "Aviso",
      emptyEdit: "Aún no se han añadido tomas.",
      emptyRead: "No hay tomas disponibles.",
      cameraLabelPrefix: "Cámara",
      clipIdLabel: "ID de clip",
      noteLabel: "Nota",
      notePlaceholder: "Nota breve sobre la toma",
      changesLabel: "Cambios",
      changesPlaceholder: "Puntos cambiados, desviaciones, notas …",
      quickRatingAria: "Valoración rápida",
      ratingTitlePrefix: "Valoración",
      removeTitle: "Eliminar toma"
    },
    settings: {
      title: "Configuración",
    ...
    clip: {
      namingLabel: "Nombre del clip",
      cameraIndexLabel: "Índice de cámara",
      cameraIndexPlaceholder: "A",
      reelNumberLabel: "Número de carrete",
      reelNumberPlaceholder: "001",
      clipNumberLabel: "Número de clip",
      clipNumberPlaceholder: "001",
      manualIdLabel: "ID de clip manual",
      manualIdPlaceholder: "Personalizado",
      namingFormatHint: "Formato: [Índice de cámara][Número de carrete]_C[Número de clip], p. ej., A001_C001",
      manualOverridesHint: "La ID de clip manual reemplaza el formato anterior."
    },
    shot: {
    ...
    lens: {
      ...
      focalLengthManual: "Longitud focal (manual)",
      focalLengthPlaceholderShort: "p. ej., 35",
      zoomRangeHint: "Objetivo zoom: solo se permiten valores dentro del rango.",
      aperture: "Apertura",
      focus: "Enfoque",
    ...
    tools: {
      ...
      fov: {
        ...
        controls: {
          ...
          manualFocalLength: "Longitud focal (manual)",
